...
/** This is a module that is modified by froilan malibiran */
// For Documentation, https://github.com/jeanregisser/react-native-slider
...
import { KPIPercentText } from '@app/screens/performance/kpi/kpi.styled.components';
...
export default class SliderEdited extends PureComponent {
  static propTypes = {
    /**
  ...
  static defaultProps = {
    ...
    thumbTouchSize: {width: 600, height: 200},
    value: 0,
  };
  ...
  render() {
    ...
    return (
      <View {...other} onLayout={this._measureContainer} style={[mainStyles.container, style]}>
        <View
        ...
        <KPIPercentText kpi={kpi}>{`${(Number(kpi.progress) * 100).toFixed(0)}%`}</KPIPercentText>
        <Animated.View
